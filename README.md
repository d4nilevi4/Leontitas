...
- [Leontitas](#leontitas)
  ...
  - [What Leontitas IS and IS NOT](#what-leontitas-is-and-is-not)
    - [What Leontitas IS](#what-leontitas-is)
    - [What Leontitas IS NOT](#what-leontitas-is-not)
    - [What's Missing from Entitas](#whats-missing-from-entitas)
  ...
  - [Quick start](#quick-start)
    - [Step 1: Declare Your World](#step-1-declare-your-world)
    - [Step 2: Define Your Components](#step-2-define-your-components)
    - [Step 3: Use the Generated API](#step-3-use-the-generated-api)
  - [Usage guide](#usage-guide)
    - [World Management](#world-management)
    - [Component Patterns](#component-patterns)
      - [Flag Components (0 fields)](#flag-components-0-fields)
      - [Single-Field Components](#single-field-components)
      - [Multi-Field Components](#multi-field-components)
  ...
  - [API reference](#api-reference)
    ...
    - [Component-Specific Methods](#component-specific-methods)
      - [0 Fields (Flag Components)](#0-fields-flag-components)
      - [1 Field (Property Components)](#1-field-property-components)
      - [2+ Fields (Method Components)](#2-fields-method-components)
    - [World API](#world-api)
