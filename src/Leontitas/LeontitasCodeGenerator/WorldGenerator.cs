...
public class WorldGenerator : IIncrementalGenerator
{
    ...
    private static void GeneratePackedEntity(string worldName, SourceProductionContext context)
    {
        ...
        sb.AppendLine("namespace Leontitas");
        sb.AppendLine("{");
        sb.AppendLine($"    public readonly struct Packed{worldName}Entity : System.IEquatable<Packed{worldName}Entity>");
        sb.AppendLine("    {");
        ...
        sb.AppendLine("        }");
        sb.AppendLine();
        sb.AppendLine($"        public bool Equals(Packed{worldName}Entity other)");
        sb.AppendLine("        {");
        sb.AppendLine("            return _instanceId == other._instanceId && _gen == other._gen;");
        sb.AppendLine("        }");
        sb.AppendLine();
        sb.AppendLine("#nullable enable");
        sb.AppendLine("        public override bool Equals(object? obj)");
        sb.AppendLine("        {");
        sb.AppendLine($"            return obj is Packed{worldName}Entity other && Equals(other);");
        sb.AppendLine("        }");
